...
def read_jsonl_to_geodataframe(file_path, n_rows=None, buffer_size=1024 * 1024):
    """
    ...
    with open(file_path, "r") as file, tqdm(
        ...
        while True:
            ...
            for line in lines:
                ...
                area_value = properties.get("area", {}).get("value") / 10000
...
n_rows = 100000  # Set to None to process the entire file
